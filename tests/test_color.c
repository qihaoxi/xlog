...
int main(void) {
    ...
    char buf[256];
    xlog_color_format_level(buf, sizeof(buf), XLOG_LEVEL_TRACE);
    printf("  %s message\n", buf);
    xlog_color_format_level(buf, sizeof(buf), XLOG_LEVEL_DEBUG);
    printf("  %s message\n", buf);
    xlog_color_format_level(buf, sizeof(buf), XLOG_LEVEL_INFO);
    printf("  %s message\n", buf);
    xlog_color_format_level(buf, sizeof(buf), XLOG_LEVEL_WARNING);
    printf("  %s message\n", buf);
    xlog_color_format_level(buf, sizeof(buf), XLOG_LEVEL_ERROR);
    printf("  %s message\n", buf);
    xlog_color_format_level(buf, sizeof(buf), XLOG_LEVEL_FATAL);
    printf("  %s message\n", buf);
    /* Test vivid scheme */
    printf("\n=== Vivid Color Scheme ===\n");
